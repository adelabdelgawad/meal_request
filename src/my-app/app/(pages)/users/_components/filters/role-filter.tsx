  ...
  return (
    <div className="relative flex items-center">
      ...
      <select
        ...
        className="pl-8 pr-8 py-1.5 text-sm border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white appearance-none cursor-pointer"
      >
