...
class EmailRoleService:
    ...
    def __init__(self):
        """Initialize service."""
        self._repo = EmailRoleRepository()

    async def create_email_role(self, session: AsyncSession, name: str) -> EmailRole:
    ...
    async def get_email_role(self, session: AsyncSession, role_id: int) -> EmailRole:
    ...
    async def get_email_role_by_name(self, session: AsyncSession, name: str) -> EmailRole:
    ...
    async def update_email_role(self, session: AsyncSession, role_id: int, name: str) -> EmailRole:
        ...
        return await self._repo.update(session, role_id, {"name": name})

    async def delete_email_role(self, session: AsyncSession, role_id: int) -> None:
