/**
 * API Route: /api/setting/roles/[roleId]/users
 * Handles role users operations
 */
...
/**
 * GET /api/setting/roles/[roleId]/users
...
export async function GET(
  ...
  try {
    ...
    const result = await serverApi.get<UserResponse[]>(url, {
      useVersioning: true,
    });
    ...
    console.error("GET /api/setting/roles/[roleId]/users error:", errorMessage);
...
/**
 * PUT /api/setting/roles/[roleId]/users
...
export async function PUT(
  ...
  try {
    ...
    // Forward to backend (body should already be in camelCase with userIds)
    ...
    const errorMessage = error instanceof Error ? error.message : "Unknown error";
    console.error("PUT /api/setting/roles/[roleId]/users error:", errorMessage);
